  ...
  return (
    <div className='relative w-full'>
      ...
      <label
        htmlFor={id}
        className={cn(
          'absolute top-5 z-10 origin-[0] -translate-y-3 text-base duration-150 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:-translate-y-4 peer-focus:scale-75',
